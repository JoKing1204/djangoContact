...
class TestContact(TestCase):
    ...
    def test_can_view_all_contacts_at_once(self):
        contacts_data = [
            {
                "name": "John",
                "email": "john.lauser@example.com",
                "phone": "037-545-839",
                "is_favorite": True,
            },
            {
                "name": "Pete",
                "email": "pete.crick@example.com",
                "phone": "663-456-3453",
                "is_favorite": False,
            },
            {
                "name": "Scarlett",
                "email": "Scarlett.johansen@example.com",
                "phone": "151-658-9801",
                "is_favorite": True,
            },
        ]
    ...
    def test_can_search_by_name(self):
        ...
        contact = models.find_contact_by_name("Scarlett")

        self.assertIsNotNone(contact)
        self.assertEqual(contact.email, "Scarlett.johansen@example.com")
    ...
    def test_can_update_contacts_email(self):
        ...
        models.update_contact_email("Pete", "king.@example.com")

        self.assertEqual(
            models.find_contact_by_name("Pete").email, "king.@example.com"
        )
